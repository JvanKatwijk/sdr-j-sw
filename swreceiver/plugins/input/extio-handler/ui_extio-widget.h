...
public:
    ...
    void setupUi(QWidget *extioWidget)
    {
        ...
        label->setGeometry(QRect(190, 120, 171, 21));
    ...
    void retranslateUi(QWidget *extioWidget)
    {
        ...
        label->setText(QApplication::translate("extioWidget", "extIO handler Version 2.2", 0));
