...
static inline
int32_t	fromPhasetoIndex (DSPFLOAT Phase, int32_t Rate) {
...
DSPFLOAT	SinCos::getSin (DSPFLOAT Phase) {
	return imag (Table [fromPhasetoIndex (Phase, Rate)]);
}

DSPFLOAT	SinCos::getCos (DSPFLOAT Phase) {
	return real (Table [fromPhasetoIndex (Phase, Rate)]);
}

DSPCOMPLEX	SinCos::getComplex (DSPFLOAT Phase) {
	return Table [fromPhasetoIndex (Phase, Rate)];
}
