...
public:
    ...
    void setupUi(QDialog *SDR)
    {
        ...
        IQBalanceDisplay->setNumDigits(3);
        ...
        attenuationLevelDisplay->setNumDigits(3);
        ...
        bandwidthDisplay->setNumDigits(5);
        ...
        bandoffsetDisplay->setNumDigits(5);
